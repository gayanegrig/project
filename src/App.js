...
const App = () => {
  ...
  return (React.createElement(React.Fragment, null,
    React.createElement(AppBar, { position: "static" },
      React.createElement(Toolbar, { variant: "dense", style: { display: 'flex', justifyContent: 'center' } },
        React.createElement(Typography, { variant: "h6", color: "inherit" }, "Management Task"))),
