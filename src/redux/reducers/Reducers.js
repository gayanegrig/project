...
export const boardReducer = createReducer({ lists: [] }, (builder) => builder
...
export const listsByIdReducer = createReducer({}, (builder) => builder
  .addCase(addList, (state, action) => {
...
export const cardsByIdReducer = createReducer({}, (builder) => builder
  .addCase(addCard, (state, action) => {
